...
import { Plus, Trash2, Edit2, Coffee, Utensils, Pizza, Salad, IceCream, Wine, Beer, Sandwich, Soup, Cake, Cookie, ChevronDown } from 'lucide-react';
...
export default function MenuManagement() {
  ...
  const [newCategory, setNewCategory] = useState<NewCategory>({ name: '', icon: 'food' });
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {categories.map((category) => {
              const IconComponent = CATEGORY_ICONS[category.icon_id as CategoryIcon];
              return (
                <button
                  key={category.id}
              ...
              >
                ...
                <div className="p-4">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <p className="text-lg font-bold text-blue-600">{Math.round(item.price)} DZD</p>
                  </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-1 text-gray-700">Price (DZD)</label>
                <div className="relative">
                  ...
                  />
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">DZD</span>
                </div>
              </div>
              <div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-1 text-gray-700">Category Icon</label>
                <select
                  className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  value={newCategory.icon}
                  onChange={(e) => setNewCategory({ ...newCategory, icon: e.target.value as CategoryIcon })}
                >
                  {Object.entries(CATEGORY_ICONS).map(([icon, Icon]) => (
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className="text-gray-700 font-semibold text-lg">Preview</span>
              </div>
              <div className="flex gap-3">
                <button
