  ...
  useEffect(() => {
    const fetchRestaurantData = async () => {
      ...
      try {
        ...
        // Fetch restaurant (must be restaurant type)
      ...
      {Object.keys(cart).length > 0 && (
        <div className="fixed bottom-6 right-6">
          <button
            ...
            className="flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white py-3 px-5 rounded-full shadow-lg transition-colors"
          >
                    ...
                    <input
                      ...
                      className={`w-full rounded-md border ${
                        formErrors.customerName
                          ? "border-red-500"
                          : "border-slate-300"
                      } px-3 py-2 focus:outline-none focus:ring-1 focus:ring-red-500`}
                    />
                    {formErrors.customerName && (
