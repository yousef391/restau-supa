      ...
      <div className="relative w-full max-w-md rounded-lg bg-gray-800 p-8 shadow-xl">
        ...
        <div className="relative z-10">
          ...
          <div className="flex justify-center mb-8">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 167.6 167.6" className="h-10 w-auto text-green-500"><path fill="currentColor" d="M83.8 0C37.5 0 0 37.5 0 83.8s37.5 83.8 83.8 83.8 83.8-37.5 83.8-83.8S130.1 0 83.8 0zm42.5 120.7c-2.3 3.9-7.2 5.1-11.1 2.8-16.1-9.8-36.4-12.4-62-7.9-4.3.7-8.6-1.8-9.3-6.1-.7-4.3 1.8-8.6 6.1-9.3 29.6-5 52.7-2.2 71.5 9 3.9 2.3 5.1 7.2 2.9 11.1zm10.7-21.9c-2.7 4.6-8.3 6.2-12.9 3.5-18.5-10.9-46.8-14.2-78-9.2-4.8.8-9.7-1.8-10.5-6.6-.8-4.8 1.8-9.7 6.6-10.5 34.3-5.6 65.1-2.3 86.5 10.7 4.7 2.8 6.2 8.4 3.6 13zm0-22.4c-3.1 5.2-10 6.6-15.2 3.5-22.7-14-56.9-17.7-90.6-10.5-5.5 1.1-11.2-2.3-12.2-7.9-1.1-5.5 2.3-11.2 7.9-12.2 37.4-7.3 76.3-3.9 102.6 12.1 5.2 3.1 6.6 10 3.5 15.2z"/></svg>
          </div>

          {/* Sign In / Sign Up Tabs */}
          <div className="flex justify-center mb-8 space-x-6">
            <button className="text-white text-lg font-semibold border-b-2 border-green-500 pb-1">SIGN IN</button>
            <Link to="/register" className="text-gray-400 hover:text-white text-lg font-semibold transition-colors duration-200 pb-1">SIGN UP</Link>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            {/* Email Input */}
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-gray-300">Username or email address</label>
              <div className="mt-1">
                <input
                  id="email"
                  type="email"
